...
class InsertDeleteGetrandomO1 {
    ...
    class RandomizedSet() {
        private val randomStorage = hashMapOf<Int, Int>()

        fun insert(`val`: Int): Boolean {
            if (randomStorage[`val`] == null) {
                randomStorage[`val`] = `val`
                return true
            }
            return false
        }
        ...
        fun remove(`val`: Int): Boolean {
            ...
            randomStorage.remove(`val`)
            return true
        }

        fun getRandom(): Int {
            return randomStorage[randomStorage.keys.random()] ?: 0
        }
